...
#ifndef JOYSTICK_VEHICLE_INTERFACE_HPP
#define JOYSTICK_VEHICLE_INTERFACE_HPP
...
private:
  ...
  bool8_t handle_active_button(Buttons button);
  bool8_t handle_inactive_button(Buttons button);
...
#endif  // JOYSTICK_VEHICLE_INTERFACE_HPP